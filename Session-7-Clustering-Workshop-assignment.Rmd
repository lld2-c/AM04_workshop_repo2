...
ggplot(userdata_withClusters, aes(x = total_Time, y = weekend, color =  as.factor(cluster))) +
...
#train kmeans clustering
model2_kmeans_2clusters<-eclust(userdata_train4, "kmeans", k = 2,nstart = 50, graph = FALSE)


#add clusters to the data frame
userdata_withClusters2<-mutate(userdata_train4, cluster = as.factor(model2_kmeans_2clusters$cluster))

#plot two principle components
fviz_cluster(model2_kmeans_2clusters, userdata_train4, palette = "Set2", ggtheme = theme_minimal())
...
```{r Silhouette}
#your code here
fviz_nbclust(userdata_train2, kmeans, method = "silhouette",k.max = 15)+labs(subtitle = "Silhouette method")
